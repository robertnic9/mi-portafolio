...
export default function Hero() {
  return (
    <section
      ...
      id="hero"
    >
      <p className="uppercase text-2xl md:text-6xl mb-3 text-white md:font-thin">
        Robert Nicuta
      </p>
      <h1
        className="uppercase text-4xl md:text-8xl mb-4 text-center
      bg-[linear-gradient(110deg,#000103,35%,#fed7aa,65%,#000103)] bg-[length:200%_100%] animate-shimmer bg-clip-text text-transparent md:font-thin"
      >
